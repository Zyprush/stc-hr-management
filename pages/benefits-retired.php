...
<script>
    $(document).ready(function() {
        ...
        function exportToExcel() {
            ...
            // Prepare Excel data
            var excelData = [
                ['List of Retirement beneficiaries.'], // Title/Header row
                ['Name', 'Office', 'Position', 'Age']
            ];

            data.forEach(function(row) {
                excelData.push([row.name, row.office, row.position, row.age]);
            });
            ...
            XLSX.writeFile(wb, 'Retirement.xlsx');
        }
