...
$pageContent = [
    ...
    [
        'Fourth page' => [
            ...
            '•          ' => ['x' => $seperated_service === 'YES' ? 138 : 164 , 'y' => 96.2],
            $seperated_service_details => ['x' => 146 , 'y' => 107.2],
            '•           ' => ['x' => $candidate === 'YES' ? 138 : 164 , 'y' => 110.5],
            $candidate_details => ['x' => 164 , 'y' => 119.5],
            '•            ' => ['x' => $q38b === 'YES' ? 138 : 164 , 'y' => 121.2],
            $q38b_details => ['x' => 164 , 'y' => 130],
            '•             ' => ['x' => $q39 === 'YES' ? 138 : 164 , 'y' => 133.2],
            $q39_details => ['x' => 145 , 'y' => 146],
            '•              ' => ['x' => $q40a === 'YES' ? 138 : 164.5 , 'y' => 158.5],
            $q40a_details => ['x' => 178 , 'y' => 167],
            '•               ' => ['x' => $q40b === 'YES' ? 138 : 164.5 , 'y' => 167.5],
            $q40b_details => ['x' => 178 , 'y' => 176],
            '•                ' => ['x' => $q40c === 'YES' ? 138 : 164.5 , 'y' => 176.5],
            $q40c_details => ['x' => 178 , 'y' => 185],

            $ref_name_1 => ['x' => 07 , 'y' => 206],
            $ref_address_1 => ['x' => 71 , 'y' => 206],
            $ref_number_1 => ['x' => 135 , 'y' => 206],

            $ref_name_2 => ['x' => 07 , 'y' => 214],
            $ref_address_2 . ' ' => ['x' => 71 , 'y' => 214],
            $ref_number_2 => ['x' => 135 , 'y' => 214],

            $ref_name_3 => ['x' => 07 , 'y' => 222],
            $ref_address_3 . '  ' => ['x' => 71 , 'y' => 222],
            $ref_number_3 => ['x' => 135 , 'y' => 222],
        ],
    ],
];
