        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Loyalty Awardee List</h4>
                    <h6>Thank you for your Over 10 years of service.</h6>
                </div>
                <div class="page-btn">
                    <!--
...
<script>
    $(document).ready(function() {
        var table = $('#event_table').DataTable({
            "ajax": {
                "url": "../config/fetch_loyalties.php",
                "type": "POST",
                "dataSrc": ""
            },
            "columns": [{
        ...
        function exportToExcel() {
            ...
            // Prepare Excel data
            var excelData = [
                ['List of Loyalty Awardees'], // Title/Header row
                [ 'Name', 'Office', 'Position', 'Duration']
            ];

            data.forEach(function(row) {
                excelData.push([ row.name, row.office, row.position, row.duration]);
            });
            ...
            XLSX.writeFile(wb, 'Loyalties.xlsx');
        }
    });
</script>