        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    ...
                    <h6>List of Employee who will recieve 13th month pay.</h6>
                </div>
                <div class="page-btn">
                    <!--
...
<script>
    $(document).ready(function() {
        ...
        function exportToExcel() {
            ...
            // Prepare Excel data
            var excelData = [
                ['List of Employee who will recieve 13th month pay.'], // Title/Header row
            ...
            XLSX.writeFile(wb, '13th Month Bunos.xlsx');
        }
